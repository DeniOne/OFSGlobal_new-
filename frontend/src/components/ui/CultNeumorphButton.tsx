  ...
  "justify-center px-4 text-sm font-medium items-center transition-[box-shadow,background-color] disabled:cursor-not-allowed disabled:opacity-50 flex active:transition-none",
  {
    variants: {
      intent: {
        ...
        primary: [
          "bg-[#2C7BE5]", // Синий цвет по умолчанию
          "text-[#fff]",
    ...
    compoundVariants: [
      {
        ...
        size: "medium",
        className: "uppercase", // Убрал uppercase, если он не нужен
      },
    ],
    defaultVariants: {
      intent: "default",
...
export interface CultNeumorphButtonProps
...
export const CultNeumorphButton: React.FC<CultNeumorphButtonProps> = ({
  className,
  intent,
  size,
  fullWidth,
